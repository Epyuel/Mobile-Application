...
class CustomerTechnicianListBookButtonClickedEvent
    extends CustomerTechnicianListEvent {
  String iso;
  int technicianId;
  String notes;
  CustomerTechnicianListBookButtonClickedEvent(
      {required this.iso, required this.technicianId, required this.notes});
}

class CustomerTechnicianListHomeButtonClickedEvent
    extends CustomerTechnicianListEvent {}
